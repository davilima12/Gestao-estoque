...
Route::get('/usuario/edit/{id}' , 'CadastrarFuncionarController@edit')->name('editar.funcioanario')->middleware('Login');
Route::post('/usuario/edit/{id}' , 'CadastrarFuncionarController@update')->name('atualizar.funcioanario')->middleware('Login');
Route::get('/usuario/delete/{id}' ,'CadastrarFuncionarController@destroy' )->name('excluir.funcionario')->middleware('Login');
